...
export const translations = {
  vi: {
    ...
    success1: "Link tải sẽ được gửi tới email của bạn",
  ...
  en: {
    ...
    success1: "The download link will be sent to your email",
    success2: "The link is valid for 72 hours",
    form: {
      fullName: "Full name",
      email: "Email",
      phone: "Phone",
  ...
  zh: {
    ...
    success1: "下载链接将发送到您的邮箱",
    success2: "链接在 72 小时内有效",
    form: {
      fullName: "姓名",
      email: "邮箱",
      phone: "电话",
